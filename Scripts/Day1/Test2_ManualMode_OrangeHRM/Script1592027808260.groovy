...
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/b_Directory'), 2)

WebUI.click(findTestObject('Page_OrangeHRM/b_Directory'))

WebUI.click(findTestObject('Page_OrangeHRM/a_Welcome Admin'))

WebUI.waitForElementVisible(findTestObject('Page_OrangeHRM/a_Logout'), 2)
